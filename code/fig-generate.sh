...
# rm -rf $parent_dir/results/figs/

figs_dir=$parent_dir/results/figs

# 设置目标目录
target_dir=$parent_dir/results/figs/temp
...
# ISIC2016_filename="ISIC_0000052.jpg"
# ISIC2017_filename="ISIC_0016072.jpg"
# Atlas_filename="Atlas_791.jpg"
# # Dermofit_filename="D526b.jpg"
# # Dermofit_filename="B792.jpg"
# PH2_filename="IMD_160.jpg"
# Dermofit_filename="C350.jpg"


# 定义目录和模型数组
# dir_directories="HAM10000 AtlasZoomIn10 ISIC2016 ISIC2017 Dermofit PH2"


# model_directories="UNet nnUNet PSAM OnePrompt_points SAMAuto SAMSpecific ScribbleSaliency MedSAMAuto"


# 一些失败的例子
# HAM10000_filename="ISIC_0024522.jpg"
# HAM10000_filename="ISIC_0024709.jpg"
# HAM10000_filename="ISIC_0025791.jpg"
HAM10000_filename="ISIC_0029634.jpg"
dir_directories="HAM10000"


# PH2_filename="IMD_251.jpg"
# dir_directories="PH2"
    ...
    if [ -d "$source_dir" ]; then
        ...
        for model in $model_directories; do
            if [ "$model" = "PSAM" ]; then
                ...
                model_dir="$source_dir/output/test/$model"
            fi
            ...
            if [ -f "$model_dir/$filename_var" ]; then
                ...
                if [ "$model" = "MedSAMAuto" ]; then
                    source_file=$save_dir/$new_filename
                    python $parent_dir/code/py_scripts/figs/add_box.py  --source-file $source_file --gt-mask-path $gt_mask_path
                fi
                ...
                # # add scribbles to ScribbleSaliency
                # if [ "$model" = "ScribbleSaliency" ]; then
                #     source_file=$save_dir/$new_filename
                #     scribbles_path=$source_dir/input/${dir}_test_scribbles_42.csv
                #     python $parent_dir/code/py_scripts/figs/add_scribbles.py --source-file $source_file --scribbles-path $scribbles_path 
                # fi
